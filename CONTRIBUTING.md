# 利用支援事例リポジトリへの貢献について / Contributing to the User Support Case Studies Repository
...
>
> **This repository does not accept Pull Requests.** Please submit feedback via **Issues**.

利用支援事例リポジトリへの貢献に関心をお寄せいただきありがとうございます。

Thank you for your interest in contributing to the **User Support Case Studies Repository**.
